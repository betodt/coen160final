	...
	public Map<String, Data> generateData(DefaultListModel<RcM> model) {
		...
		for (int i = 0; i < model.getSize(); i++) {
			...
			if(Integer.parseInt(sub) % 10 == 0)
				...
				label = "";
			data.put("RcM" + label + sub, model.getElementAt(i).getData());
		}
		return data;
	}
}
